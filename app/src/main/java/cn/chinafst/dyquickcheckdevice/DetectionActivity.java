...
public class DetectionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView tvItem,tvSample,tvLimit;
    private PosApi mApi = null;
    private PrintQueue mPrintQueue = null;

    private String baseUrl="http://zjdy.chinafst.cn:8085/lezhifda/";
    @Override
        ...
        public void onReceive(Context context, Intent intent) {
           ...
           /* showScanResult.append("广播输出：");
            ...
            if(barcodeStr.contains("samplingNO=")){
                requestInfo(barcodeStr.substring(barcodeStr.indexOf("=")+1));
            }else{
                            ...
                            if ("success1".equals(jsonObject.getString("resultCode"))) {
                                JSONArray result = jsonObject.getJSONArray("result");
                                    if(result.length()>0){
                                        ...
                                        Toast.makeText(getApplicationContext(), object.getString("ckoName"),Toast.LENGTH_SHORT).show();
    ...
    private void sacnLine(final Bitmap bitmap) {
       ...
       /*     @Override
            ...
            protected void onPostExecute(String[] s) {
                ...
                for (int i = 0; i < s.length; i++) {
                    yVals.add(new Entry(i,Float.parseFloat(s[i])));
